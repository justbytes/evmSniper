...
import { IUniswapV2Pair } from "@uniswap/v2-core/build/UniswapV2Pair.json" with { type: 'json' };
const { abi: IUniswapV2PairABI } = IUniswapV2Pair;
...
export class UniswapV2 {
  ...
  async buyToken() {}
  async sellToken() {}
  async startTargetListener() {}
  async stopTargetListener() {}
